...
class VTmodule:
    ...
    # define a private method that generates a file called {self.__name}_mmio.vs, this file should contain the mmio registers
    def __generate_mmio(self):
        # define a variable mmio_file which is the file to be generated
        mmio_file = open(self.__name + "_mmio.vs", "w")
        # write the header of the file
        mmio_file.write("/*\n")
        mmio_file.write(" * This file is generated by VTmodule.py\n")
        mmio_file.write(" * It contains the mmio registers of " + self.__name + "\n")
        mmio_file.write(" */\n\n")
        # write the mmio registers
        for mmio_reg in self.__mmio_regs:
            mmio_file.write(mmio_reg.get_verilog())
        # close the file
        mmio_file.close()
