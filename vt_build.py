...
from vt_colours import INFO, OK, WARNING, ERROR, DEBUG
...
def move_to_generated_dir(script_path, current_directory, sources_list, verilog_files):
    ...
    and moves them to the "hardware/generated/" directory. It updates the sources_list and verilog_files accordingly.
    """
    verilog_extensions = [".v", ".vh", ".sv", ".svh", ".vs"]
    verilog_files_found = []
...
def parse_arguments():
    ...
    This function parses command-line arguments provided when calling VTBuild. It extracts information such as the
