...
> Usage: python *vs\_build*.py \<main\_module> [OPTIONS] [EXTRA_ARGS ...]
...
> \--Boards \<board\_modules> (optional) -> Space-separated list of board top modules (e.g., "Board1 Board2").
...
> Extra positional arguments (optional) -> forwarded unchanged to generator scripts (see below).

Clean the contents generated by *vs\_build*:

> Usage: python *vs\_build*.py --clean
> Removes the "build" and "generated" directories.
